@echo off
REM Vivado Command-line Simulation Script for Windows
REM This script compiles, elaborates, and runs the RISC-V simulation

REM Add Vivado to PATH
set PATH=C:\Xilinx\2025.1\Vivado\bin;%PATH%

echo ========================================
echo RISC-V SystemVerilog Simulation
echo ========================================
